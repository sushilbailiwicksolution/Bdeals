$(document).ready(function(){
	...
	$('#btn_up').click(function(){
		...
		callAjax( base_url+"admin/jv_edit/seller_up", $('#seller_up').serialize(), "JSON", onSuccess, onError );
	});

	$('#btn_bi').click(function(){
		callAjax( base_url+"admin/jv_edit/seller_binfo", $('#seller_binfo').serialize(), "JSON", onSuccess, onError );
	});

	$('#btn_bd').click(function(){
		callAjax( base_url+"admin/jv_edit/seller_bd", $('#seller_bdescription').serialize(), "JSON", onSuccess, onError );
	});

	$('#btn_ad').click(function(){
		callAjax( base_url+"admin/jv_edit/seller_adetails", $('#seller_adetails').serialize(), "JSON", onSuccess, onError );
	});
	
	$('#btn_jv').click(function(){
		callAjax( base_url+"admin/jv_edit/jv_details", $('#jv_details').serialize(), "JSON", onSuccess, onError );
	});
	
	$('#btn_upload').click(function(){
		callAjax( base_url+"admin/jv_edit/seller_upload", $('#seller_upload').serialize(), "JSON", onSuccess, onError );
	});
	
	$('#btn_as').click(function(){
		callAjax( base_url+"admin/jv_edit/seller_aservice", $('#seller_aservice').serialize(), "JSON", onSuccess, onError );
	});	
});
