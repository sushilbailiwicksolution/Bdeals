    ...
    <section class="sec-padding paddbott">
        <div class="container">
		   ...
		   <span style="float: right; color: #000; font-size: 14px; font-weight: bold;">listing ID #<?php echo $businessData[0]['id']; ?></span>
				...
				<div class="col-md-12  asking-top-area " style="display:none;">
				<div class="col-md-4 asking-part">
				<h4>Asking Price</h4>
				<h3><span><?php echo $businessData[0]['latest_revenu_currency'];?></span> <?php echo $businessData[0]['latest_revenu'].' '.$businessData[0]['latest_revenu_unit']; ?></h3>
				</div>
				<div class="col-md-4 asking-part">
				<h4>Sales Revenue</h4>
				<h3><?php echo $businessData[0]['ask_price_currency'].' ' . $businessData[0]['ask_price'].' '.$businessData[0]['ask_price_unit']; ?></h3>
				</div>
				<div class="col-md-4 asking-part">
				<h4>Category</h4>
				<h3><?php
		...
		<div class="col-md-12 padd0">
				<div class="col-md-4">
					<div class="asking-part">
						<h4>Asking Price</h4>
						<h3><span><?php echo $businessData[0]['ask_price_currency'];?></span> <?php echo $businessData[0]['ask_price'].' '.$businessData[0]['ask_price_unit']; ?></h3>
					</div>
				</div>
				<div class="col-md-4">
					<div class="asking-part">
						<h4>Real Estate Value</h4>
						<h3><?php echo $businessData[0]['latest_revenu_currency'].' '.$businessData[0]['latest_revenu'].' '.$businessData[0]['latest_revenu_unit']; ?></h3>
					</div>
				</div>
				<div class="col-md-4">
					<div class="asking-part">
				...
				<div class="col-md-4 ">
					<div class="asking-part">
						<h4>Business Listed By</h4>
						<h3><?php if($businessData[0]['business_listed_by']==''){ echo 'NA'; }
						else{
							echo $businessData[0]['business_listed_by'];
		...
		<div class="col-md-4 padd0 mt_35">
			<div class="padd0 contact-seller-a">
				...
				<button type="submit" class="savebtn" data-toggle="modal" data-target="#contactseller">Contact Seller</button>
					<h4><?php if( $msgToDis != null ){echo '&nbsp;('.$msgToDis.')';}else if($contactFromResponse=='Kindly Click Above to Contact'){ //echo 'Kindly Click Above to Contact';
				}
...
<div class="label-likes"><?php if($businessData[0]['add_to_favorite']=='1') { echo "Remove from favourite"; }else{echo "Add to favourite";} ?></div>
			...
			<div class="col-md-4 padd0 bmargin">
			...
			<div class="col-md-6 padd0">
			<label>Purpose of JV</label><?php 
			if($businessData[0]['purpose_jv']=='Others'){
				
			echo $businessData[0]['purpose_jv_other'];
				
			}else{
				
			echo $businessData[0]['purpose_jv'];

			}			?></p>
			</div>
			<div class="col-md-6 padd0">
			<label>Previous Investment</label><?php echo $businessData[0]['previous_investment_currency'].' '.$businessData[0]['prev_investment'].' '.$businessData[0]['previous_investment_unit']; ?></p>
			</div>
			<div class="col-md-6 padd0">
			<label>Investment Required</label><?php echo $businessData[0]['investment_required_currency'].' '.$businessData[0]['reqd_investment'].' '.$businessData[0]['investment_required_unit']; ?></p>
			</div>
			<div class="col-md-6 padd0">
			<label>Invest range</label><?php echo $businessData[0]['invest_range']; ?></p>
			</div>
			<div class="col-md-6 padd0">
			<label>Role of New Investor</label><?php 
			if($businessData[0]['role_new_investo']=='Others'){
			
			echo $businessData[0]['role_new_invest_other']; 
			
			}else{	
			
			echo $businessData[0]['role_new_investo']; 
			
			}
			?></p>
			</div>
			<div class="col-md-4 padd0">
			<label>Proposed Deal Structure</label><?php echo $businessData[0]['proposed_deal']; ?></p>
			</div>
