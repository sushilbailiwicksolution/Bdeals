               ...
               <div class="tab-pane active" id="basicinformation">
                <div class="panel-body">
                 <div class="col-sm-12 padd0">
                  <div class="form-c-box">
		   <form id="seller_businfo" name="seller_businfo" method="POST">
		   <div class="areu">
                   <div class="col-sm-12">
                    <div class="form-group">
...
<?php
                       ...
                       <input type="text" id="listing_sub_category_other_2"  name="listing_sub_category_other_2" class="form-control" placeholder="Other Sub Category" value="<?php echo $businessDetails[0]['listing_sub_category_other'];?>"  data-error="sub category required" style="display:none;"/>
                        <div class="help-block with-errors"></div>
                       </div>
                      </div>
                      <div class="col-sm-3">
...
?>
                   ...
                   <div class="col-sm-5" style="padding-right:0">
                    ...
                    <button type="button" class="savebtn cstatusbus" id="btn_bi3">Save &amp; Continue</button>
                   </div>
                  </form>
                 </div>
                </div>
...
?>
	...
	<input type="image" style="display:none;" name="button-remove_<?php echo $ii; ?>" id="finbutton-remove_<?php echo $ii; ?>" value="<?php echo $sellBusinessAdditionalFinancialDetails[$ii-1]['id'];?>&<?php echo $ii; ?>" class="button-remove_<?php echo $ii; ?> finbutton-remove" onclick='RemoveFin(this)' src="<?php echo asset_url();?>images/delete.png" />			
               ...
               <div class="tab-pane" id="Uploads">
                <div class="panel-body">
                 <div class="col-sm-12 padd0">
				  <form action="<?php echo base_url();?>lb_userregister" class="upload-image-form" enctype="multipart/form-data" method="post" accept-charset="iso-8859-1">
                     <div class="form-c-box">
                  <div class="areu">
                  <p>Upload Photos</p>
                        <div class="col-sm-12">
...
<button type="button" class="savebtn" id="packde" style="align:right;">Continue</button>
...
?>
                   ...
                   <div class="col-sm-3"></div>
                   <div class="col-sm-5" style="padding-right:0">
                    <button type="button" class="savebtn" id="packcont">Continue</button>
                   </div>
