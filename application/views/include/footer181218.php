...
<section class="section-fulldark sec-padding ">
        ...
        <div class="col-md-3 clearfix">
          <div class="item-holder">
            ...
            <ul class="address-info no-border">
              <li class="color-ft">Address: 505 Manisha Building, Nehru Place, New Delhi, India</li>
              <li class="color-ft"><i class="fa fa-phone"></i> Phone: +91-11-41064800</li>
              <li class="color-ft"><i class="fa fa-fax"></i> Fax: +91-11-41064800</li>
              <li class="color-ft last"><i class="fa fa-envelope"></i> Email: enquiry@businessdeals.in </li>
            </ul>
          </div>
        </div>
  ...
  <section class="section-copyrights sec-moreless-padding ptb15 ">
    <div class="container">
      <div class="row">
        <div class="col-md-12 color-ft"> <span>Copyright © 2018 Business Deals. All rights reserved.</span></div>
      </div>
    </div>
  </section>
  <!--end section-->
...
<div id="style-selector" class="popup-1" > <a href="javascript:void(0);" class="btn-close"><span></span><p> Quick Contact</p></a>
  ...
  <div class="form-group out-label">
   <div class="input-group ">
   <div class="input-group-addon currency " style="width:41px;">
                          <select class="form-control" id="country_code" name="country_code" style="height: 28px;
...
?>
	...
	<input type="text" class="form-control" name="contact" style="width: 259px;" placeholder="Contact No." id="uq_contact">
	
	</div>
    <div id="error_mob" class="help-block with-errors" style="display:none;"></div>
  </div>
  <div class="form-group">
  ...
  <div  class="form-group" style="background-color: #fd8509;
    border: 2px solid #fd8509;
    height: 38px;">
...
<div style="    margin-top: -4px; margin-bottom: 9px; float: left; display: block;" class="form-group">
...
var userid =$("#userid").val();
		...
		$.ajax({
			...
			if(data == 2){
				...
				var url='<?php echo site_url("forgetUseridOtp")?>';
...
<script>
 function Favourite(addtofavourite,action) {
	...
	switch(action) {
		case "like":
		$('#favourite-'+addtofavourite+' .btn-likes').html('<input type="button" title="Remove from favourite" class="unlike" onClick="Favourite('+addtofavourite+',\'unlike\')" /> Remove from favourite');
		likes = likes+1;
		break;
		case "unlike":
		$('#favourite-'+addtofavourite+' .btn-likes').html('<input type="button" title="Add to favourite" class="like"  onClick="Favourite('+addtofavourite+',\'like\')" /> Add to favourite')
		likes = likes-1;
		break;
	}
 ...
 <div class="modal-dialog mt160" role="document">
  <div class="modal-content">
   <div class="modal-header "> 	  
    ...
    <h5 class="modal-title" id="myModalLabel">Business deal login <a style="float:right;margin-right:10px;color:#eb0000  !important;" href="<?php echo base_url();?>register">Sign Up</a></h5>
   </div>
   ...
   <form id="myform"  method="POST"  class="">
       <div class="col-sm-12 ">
        <div class="form-group">
         ...
         <input type="email" class="form-control" placeholder="User id" id="userid" name="userid" required>
        </div>
       </div>
       <div class="col-sm-12 ">
        <div class="form-group">
       ...
       <div class="col-sm-7 mt5">
        <a class="mt5" href="forget-password">Forgot your password ?</a>
       </div>
...
<!-- Modal -->
<div class="modal fade bs-example-modal-lg  " id="myModalsearch" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
?>
		...
		<button class="btn-ser" > Search </button>
          ...
          <div id="Search-tab-2" class="tabs-panel1" style="display: none;">
           <div class="col-md-12 padd0">
	   <!--<form id="nrm_search" name="nrm_search" method="GET" action="<?php echo base_url();?>normal-search/">-->
	    <form method="POST" action="normal-search">
             ...
             <div class="form-group col-md-7 padd0">
              <div class="col-sm-12 padd0">
               <input type="text" class="form-control" id="search_key" name="search_key" placeholder="Normal Search">
              </div>
             </div>
