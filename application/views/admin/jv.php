...
<div class="main-content">
 <h1 class="page-title">Joint Venture <?php if( $msgToDis != null ){echo '&nbsp;('.$msgToDis.')';}?>
 
 <?php if($GetUserType=='admin'){?>
 
 <span style="margin-left:200px;font-size:16px;">All(<b id="jvall_count" class="jvall_count"></b>) | Approved(<b id="jvapproved_count" class="jvapproved_count"></b>) | Pending for approval(<b id="jvpending_count" class="jvpending_count"></b>) | Rejected(<b id="jvrejected_count" class="jvrejected_count"></b>) | Inactive (<b id="jvinactive_count" class="jvinactive_count"></b>) | Closed (<b id="jvclosed_count" class="jvclosed_count"></b>)</span>
 <?php }?>
 </h1>
 
 
  <div class="col-md-12">
  <div class="col-md-2 mb15"><input type="date" name="fromDate" class="form-control" id="JVfromDate" placeholder="From date" style="width: 153px;">
  </div>
  
  <div class="col-md-2 mb15">
 <input type="date" name="toDate" class="form-control" id="JVtoDate" placeholder="To date" style="width: 153px;">
  </div>
 
  <div class="col-md-2 mb15">
   <select name="sort_status" class="form-control" id="JVsort_status">
  ...
  <!--<div class="col-md-2 pull-left mb15 Sellteamshow">
   ...
   <div class="col-md-2 mb15">
    ...
    <select class="custom-s JVsortbycity form-control" id="JVSellsort_city" name="city"  >
...
?>						
 ...
 <div class="col-md-2">
               <Select class="form-control" id="categoryJV"  name="sector" >
...
<div class="col-md-2">
                 <select class="custom-s form-control" id="pricetypeJV" name="price" data-error="Price Range required" >
...
?>
 ...
 <div class="col-md-12">
 <div class="col-md-2 mb15"><a href="<?php echo base_url();?>admin/JVReport" class="btn btn-sm btn-danger">Export JV data</a></div>
 </div>
 <div class="row">
  ...
  <div class="col-md-12  table-responsive">
   <table id="jv-table" class="table table-striped table-bordered table-hover">
    <thead>
     <tr>
