...
<div class="main-content">
 <h1 class="page-title">User - case</h1>
 <div class="row">
  <div class="col-md-12">
   <div class="panel panel-default">
    <div class="panel-body">
    <form class="form-horizontal" id="frm_create_case" method="POST" action="<?php echo base_url();?>admin/createUserCase">
      <div class="form-group">
       ...
       <div class="col-sm-5">
        ...
        <input type="text" id="case_id" name="case_id" value="<?php echo $formId;?>" />
