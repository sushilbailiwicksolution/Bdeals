...
<h1 class="page-title">Add New User <?php echo $flashVal;?></h1>
 
 <div class="panel panel-default">
  <div class="panel-body">
   <div class="form-c-box">
       <div class="row">
      <div class="col-sm-12 r-bgc">
       <form name="frm_reg" action="newuser_add" method="post" data-toggle="validator" role="form" class="was-validated">
        <div class="form-c-box">
		 ...
		 <p>Confidential Registration <label style="color: #a94442;"><?php if( $msgToDis != null ){echo '&nbsp;('.$msgToDis.')';}?></label></p>
				 <div class="col-sm-12">
                  ...
                  <div class="col-sm-4">
					...
					<input type="hidden" name="user_id" id="user_id" value="buy_a_business" />
					<input type="hidden" name="newuser" id="newuser" value="newuser" />
			...
			placeholder="Name" data-error="Name required OR Invalid name" required>
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="email" id="lb_email" name="lb_email" pattern="([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})" class="form-control"  placeholder="Email" data-error="Email required OR Invalid Email" required>
                    <div class="help-block with-errors"></div>
                    </div>
                  </div>
                  <div class="col-sm-4">
            ...
            <div class="help-block with-errors"></div>
		      ...
		      <input type="checkbox" class="cus-t" id="checkbox1" name="lb_owner" value="owner"  <?php if(strcasecmp($sellBusinessUserProfile[0]['who'], 'owner')==0){ echo "checked";}?> >
                  ...
                  <div class="col-sm-4" style="padding-right:0">
                   ...
                   <button type="submit" class="savebtn buyerBS">Save</button>
                  </div>
