...
<div class="main-content">
 <h1 class="page-title">Start Up <?php if( $msgToDis != null ){echo '&nbsp;('.$msgToDis.')';}?>
 
 <?php if($GetUserType=='admin'){?>
 
 <span style="margin-left:200px;font-size:16px;">All(<b id="stall_count" class="stall_count"></b>) | Approved(<b id="stapproved_count" class="stapproved_count"></b>) | Pending for approval(<b id="stpending_count" class="stpending_count"></b>) | Rejected(<b id="strejected_count" class="strejected_count"></b>) | Inactive (<b id="stinactive_count" class="stinactive_count"></b>) | Closed (<b id="stclosed_count" class="stclosed_count"></b>)</span>
 <?php }?>
 </h1>

  
    <div class="col-md-12">
  <div class="col-md-2 mb15"><input type="date" name="fromDate" class="form-control" id="SPfromDate" placeholder="From date" style="width: 153px;">
  </div>
  
  <div class="col-md-2 mb15">
 <input type="date" name="toDate" class="form-control" id="SPtoDate" placeholder="To date" style="width: 153px;">
  </div>
 
  <div class="col-md-2 mb15">
   <select name="sort_status" class="form-control" id="SPsort_status">
  ...
  <!--<div class="col-md-2 pull-left mb15 Sellteamshow">
   ...
   <div class="col-md-2 mb15">
    ...
    <select class="custom-s SPsortbycity form-control" id="SPSellsort_city" name="city"  >
...
?>						
 ...
 <div class="col-md-2">
               <Select class="form-control" id="categorySP"  name="sector" >
...
?>
 ...
 <div class="col-md-12">-->
 <div class="col-md-2 mb15"><a href="<?php echo base_url();?>admin/StartUpReport" class="btn btn-sm btn-danger">Export Start Up data</a></div>
 </div>
 <div class="row">

                
  <div class="col-md-12 table-responsive">
   <table id="startup-table" class="table table-striped table-bordered table-hover">
    <thead>
     <tr>
