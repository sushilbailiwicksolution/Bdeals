...
?>
		    ...
		    <textarea id="lb_address" name="address" class="form-control" rows="3" data-error="Address required" required disabled><?php echo $userDetails[0]['address'];?></textarea>
                    <div class="help-block with-errors"></div>
                    </div>
                  </div>
                  <div class="col-sm-4">
          ...
          <div class="col-sm-4">
           <div class="form-group">
            ...
            <input type="password" class="form-control" placeholder="" id="passwd" name="password" data-error="Password required"  disabled>
            <div class="help-block with-errors"></div>
           </div>
          </div>
          <div class="col-sm-4">
           <div class="form-group">
            ...
            <input type="password" class="form-control" placeholder="" id="cpasswd" name="cpasswd" data-match="#passwd" data-match-error="Oops!, password don't match" data-error="Confirm password required"  disabled>
            <div class="help-block with-errors"></div>
           </div>
          </div>
         </div>-->
  ...
  <div class="col-md-12" style="padding-bottom:10px;">
   ...
   <?php } if ( $userDetails[0]['status'] ==1){   ?>
	...
	<?php }?>
	    ...
	    <div class="col-md-12">
					<form method="POST" action="<?php echo base_url();?>/validateCustomer">
