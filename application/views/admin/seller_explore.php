<?php
 ...
 //echo $businessDetails[0]['location_region'];
...
<div class="main-content">
                <h1 class="page-title">Business for Sell <?php if( $msgToDis != null ){echo '&nbsp;('.$msgToDis.')';}?></h1>
                ...
                <div class="row ">
                    <div class="col-md-12">
                        <div class="tabs-container">
							...
							<form id="seller_up11" name="seller_up" method="POST" action="<?php echo base_url();?>admin/seller/UpdateSeller" enctype="multipart/form-data">
  ...
  <label for="">Address: <?php echo $businessDetails[0]['address'];?></label>
							...
							<input type="text" name="keyHeadline" id="keyHeadline" class="form-control" placeholder="Business Heading" maxlength="100" value="<?php echo $businessDetails[0]['key_headline'];?>"  >
                                                    </div>
                                                </div>
...
?>
                      ...
                      <div class="col-sm-4">
                        ...
                        <Select class="form-control" id="bstatus" name="bstatus" required data-error="Business Status required">
                          <option value="">Select</option>
<?php
			 foreach( unserialize(BUSINESS_CURRENT_STATUS_SELL) as $currentStatusValue => $currentStatusName ){
?>
...
?>
										...
										<input type="text" class="form-control" pattern="[1-9]{0}[0-9]*" id="ask_price" name="ask_price_real" placeholder="Amount" value="<?php echo $sellBusinessAdditionalDetails[0]['ask_price_real'];?>" onkeyup="resetPriceRange('#price_range_type',this.value)" style="width: 78px; height: 39px;" data-error="Asking Price required" required>
										<div class="input-group-addon currency" style="align: left; float: left; width: 115px; height: 39px; ">
 ...
 <video width="120" controls style="margin-top:-45px;">
  ...
  ?></h4>										
						 ...
						 <div class="col-md-12" style="padding-bottom: 50px;">
						                 <div class="col-md-2">
                  <a href="<?php echo base_url();?>admin/expl_case/sell/<?php echo $assignedTo;?>/<?php echo $formId;?>"><button style="float:left;" type="button" class="savebtn">Case</button></a>&nbsp;&nbsp;
                 </div>
<?php
...
?>
  ...
  <li><a class="dropdown-item" href="#">Select</a></li>
   ...
   <li> <a  class="dropdown-item" href="<?php echo base_url();?>admin/expl_accept/sell/accept/<?php echo $formId;?>">Approve</a></li>
   <li><li> <a class="dropdown-item" href="<?php echo base_url();?>admin/expl_accept/sell/reject/<?php echo $formId;?>">Reject</a></li>
    <li><a class="dropdown-item" href="<?php echo base_url();?>admin/expl_accept/sell/inactive/<?php echo $formId;?>">Inactive</a></li>
	<li><a class="dropdown-item" href="<?php echo base_url();?>admin/expl_accept/sell/closed/<?php echo $formId;?>">Closed</a></li>
	</ul>
...
?>
		<div class="col-md-2">
                 <button style="margin: 5px;" type="button" class="savebtn editSeller">Edit</button>
		</div>
                    </div>
					</div>
                </div>
