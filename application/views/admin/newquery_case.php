 ...
 <div class="row">
  <div class="col-md-12">
   <div class="panel panel-default">
    ...
    <form class="form-horizontal" id="frm_create_case" method="POST" action="<?php echo base_url();?>admin/createQueryCase">
      ...
      <div class="form-group">
	   ...
	   <div class="form-group">
       <label class="col-sm-3 control-label" for="inputEmail3">Form Status</label>
       <div class="col-sm-5">
        <select name="form_status" id="status" class="form-control">
         <option value="" selected="">Select Status</option>
   ...
   <div class="col-md-12">
   <a href="<?php echo base_url();?>admin/QueryfollowupReport/query/<?php echo $assignedTo;?>/<?php echo $formId;?>" class="btn btn-sm btn-danger">Export Query Follow up Data</a>
