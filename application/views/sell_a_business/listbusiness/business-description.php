              ...
              <div class="col-sm-3">
                <div class="feat-c-box">
                  <ul>
                    ...
                    <li><a href="list-your-business-description" class="active-page">Business Description</a></li>
...
?>
										...
										<input type="text" class="form-control" pattern="[1-9]{1}[0-9]*" id="ask_price" name="ask_price" placeholder="Amount" value="<?php if($sellBusinessDescription[0]['ask_price']>0){echo $sellBusinessDescription[0]['ask_price'];};?>" onkeyup="resetPriceRange('#price_range_type',this.value)" style="width: 78px; height: 39px;" data-error="Asking Price required" required>
...
?>
		    ...
		    <textarea class="form-control" rows="3" placeholder="What is the future growth potential" id="growth" name="growth" data-error="Growth Potential required" required><?php echo $sellBusinessDescription[0]['growth_potential'];?></textarea>
			<div class="help-block with-errors"></div>
                    </div>
                  </div>
                  <div class="col-sm-12">
			...
			<div class="help-block with-errors"></div>
                  ...
                  <div class="col-sm-5" style="padding-right:0">
                    ...
                    <button type="submit" class="savebtn saleBD">Save &amp; Continue</button>
					 ...
					 <a href="<?php echo base_url();?>list-your-business-basic-information" class="backbtn">Back</a>
                  </div>
                </div>
               </form>
             </div>
