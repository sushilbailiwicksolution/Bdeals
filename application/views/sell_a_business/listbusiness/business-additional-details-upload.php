        ...
        <div class="col-md-12 gtco-heading ">
          ...
          <div class="row">
              <div class="col-sm-3">
                <div class="feat-c-box">
                  <ul>
                    ...
                    <li><a href="list-your-business-additional-details-uploads" class="active-page">Uploads</a></li>
              ...
              <div class="col-sm-9 r-bgc">
               <form action="lb_userregister" class="upload-image-form" enctype="multipart/form-data" method="post" accept-charset="iso-8859-1">
 ...
 <form action="lb_userregister" class="upload-image-form" enctype="multipart/form-data" method="post" accept-charset="iso-8859-1">
				...
				<a href="?delete=<?php echo $media['id'];?>" class="delete" style="float: right;"><i class="fa fa-trash"></i></a>
                  ...
                  <div class="col-sm-12" style="padding-right:0">
                   ...
                   <form action="list-your-business-package-details">
