          ...
          <div class="row">
              <div class="col-sm-3">
                <div class="feat-c-box">
                  <ul>
                    <li><a href="list-your-business-user-profile" class="active-page">User Profile</a></li>
              ...
              <div class="col-sm-9 r-bgc">
                ...
                <div class="form-c-box">
                  <div class="col-sm-4">
					...
					<input type="hidden" name="business_type" id="business_type" value="sell_a_business" />
