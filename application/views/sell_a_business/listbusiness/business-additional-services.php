             ...
             <div class="col-sm-3">
                <div class="feat-c-box">
                  <ul>
                    ...
                    <li><a class="active-page" href="list-your-business-additional-services">Additional Services</a></li>
               ...
               <form name="lb_uprof" action="lb_userregister" method="post" data-toggle="validator" role="form" class="was-validated">
                <div class="form-c-box">
                  <div class="areu">
					...
					<div class="col-sm-4">
                      <div class="checkbox">
                        <input type="checkbox" id="advertisment_website" name="advertisment_website" value="AW" <?php if(strcasecmp($additionalServices[0]['advertisment_website'], 'YES')==0){ echo "checked";}?>>
                          <label for="advertisment_website" class="cus-t">
                            Advertisment On Website
                          </label>
                      </div>
                    </div>
					</div>
                  ...
                  <div class="col-sm-5" style="padding-right:0">
                    ...
                    <button type="submit" class="savebtn saleAS">Submit</button>
                  </div>
                </div>
               </form>
              </div>
