        ...
        <div class="col-md-12 gtco-heading">
          <div class="p-15">
		    ...
		    <li><a href="list-your-business-jv-details-jv">JV-details</a></li>
                    ...
                    <li class="active-page"><a href="list-your-business-preview-jv">Preview</a></li>
                  </ul>
  ...
  <source src="<?php echo base_url().$countrydet2['path'];?>" type="video/mp4" ></video></div>
		<?php }
		  ...
		  <div class="col-md-12 border-sec">
			...
			<div class="col-md-12 padd0">
			<label>Real Estate Value</label><?php echo $additionalDetails[0]['real_state_value_type'].' '.$additionalDetails[0]['ask_price_real'].' '.$additionalDetails[0]['real_state_value_unit']; ?></p>
			</div>
			</div>
