					...
					<div class="row">
							<div class="col-sm-3">
								<div class="feat-c-box">
									<ul>
										<li><a href="realestate.php" class="active-page">User Profile</a></li>
										<li><a href="realestate-Property-Information.php">Property Information</a></li>
										<li><a href="realestate-tenancy-description.php">Tenancy Description</a></li>
									</ul>
								</div>
							</div>
