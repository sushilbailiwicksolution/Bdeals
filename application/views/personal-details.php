					...
					<div class="row">
							<div class="col-sm-3">
								<div class="feat-c-box">
									<ul>
										<li><a href="personal-details.php" class="active-page">Personal Details</a></li>
										<li><a href="business-profile.php">Business Profile</a></li>
										<li><a href="post-your-requirement.php">Post your requirement</a></li>
									</ul>
								</div>
							</div>
